...
$queryrecipe = mysqli_query($conn, "SELECT * FROM recipe WHERE recipe_id = '$recipe_id'");
$data = mysqli_fetch_array($queryrecipe);
    ...
    if (!in_array($imageExtension, $validExtension)) {
        ...
        if ($q4) {
            ...
            foreach ($ingredients as $ingredient) {
                ...
                $sql5 = "UPDATE bahan SET bahan_name = '$ingredient' WHERE resep_id = $recipeId";
...
<body>
    ...
    <div class="container">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="judul text-center"><span class="headtitle">Update</span><span>  Recipe</span></div>
            <div class="mb-3">
                <label for="recipe_name" class="form-label">Recipe Name</label>
                <input type="text" id="recipe_name" class="form-control" name="recipe_name" placeholder="Recipe Name" value="<?php echo $data["recipe_name"]; ?>">
            </div>
            <div class="mb-3">
                <label for="currentFoto">Foto Sekarang</label>
                <img src="../img/<?php echo $data["recipe_img"] ?>" alt="" width="180px" height="180px">
                <input type="file" id="recipe_name" class="form-control mt-3" name="recipe_image" accept=".jpg, .jpeg, .png" value="<?php echo $data["recipe_img"]; ?>">
            </div>
            <div class="mb-3">
                <label for="description" class="form-label">Description</label>
                <input type="text" id="description" class="form-control" name="description" placeholder="Description" value="<?php echo $data["description"]; ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea style="resize:none;width:1123px;height:250px;" id="instructions" class="form-control" name="instructions" placeholder="Instructions (descriptive)">
            ...
            <a href="recipe.php"><button type="submit" name="submit" class="btn1">Update</button></a>
            <!-- <button type="submit" name="submit" class="btn1" onclick="location.href='recipe.php'">Update</button> -->
        </form>
    </div>
