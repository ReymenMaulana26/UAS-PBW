...
$result1 = mysqli_query($conn, "SELECT recipe_id, recipe_name FROM recipe WHERE user_id = $userid");
$result2 = mysqli_query($conn, "SELECT recipe_id, recipe_name FROM recipe WHERE user_id = $userid");

$queryresep = mysqli_query($conn, "SELECT * FROM recipe");
$data=mysqli_fetch_array($queryresep);
...
if (isset($_POST['edit-btn']) && isset($_POST['recipe_id'])) {
    // Mengambil recipeId dari data pilihan
    $recipeId = $_POST['recipe_id'];
    $select = mysqli_query($conn, "SELECT * FROM `recipe` WHERE recipe_id = '$recipeId'") or die('query failed');
...
if (isset($_POST['delrecbtn']) && isset($_POST['recipe_id'])) {
    ...
    // query DELETE
    $sqlbahan = mysqli_query($conn, "DELETE FROM bahan WHERE resep_id = $recipeId");
...
<body>
            ...
            <div class="row p-3">
                ...
                <div class="col-lg-3 p-3 text-center d-flex">
                    <div class="d-grid gap-2">
                        ...
                        <button class="btn6" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">Edit</button>
    ...
    <section class="main">
        <div class="container">
            <div class="row mt-1 p-3 row-gap-4">
                <h1>My Recipes</h1>
                <div class="col-lg-9">
                    <div class="row">
                        <?php
                ...
                <div class="col-lg-3 p-3 text-center d-flex">
                    <div class="d-grid gap-2">
                        ...
                        <button type="button" class="btn6" data-bs-toggle="modal" data-bs-target="#edit-modal">Edit</button>
                        <button type="button" class="btn3" data-bs-toggle="modal" data-bs-target="#delete-modal">Delete</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="editrecipe" class="form-label ">Choose recipe to edit</label>
                            <?php
                            if (mysqli_num_rows($result1) > 0) {
                                echo '<select name="recipe_id" id="editrecipe">';
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="edit-btn" class="btn6">Edit</button>
                        <button type="button" class="btn2" data-bs-dismiss="modal">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="delrecbtn" class="btn3">Delete</button>
                        <button type="button" class="btn2" data-bs-dismiss="modal">Cancel</button>
                    </div>
                </form>
            </div>
