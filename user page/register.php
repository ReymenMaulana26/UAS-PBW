...
if (isset($_POST['submit'])) {
    ...
    $profpic = ''; // Atau beri nilai default, misalnya 'default.png'
    ...
    if (mysqli_num_rows($select) > 0) {
        ...
        mysqli_query($conn, "INSERT INTO `user`(username, email, password, profpic) VALUES('$name', '$email', '$pass', '$profpic')") or die(mysqli_error($conn));
