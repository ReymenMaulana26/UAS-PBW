...
<body>
    ...
    <div class="container">
        <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
            <div class="judul text-center mt-4"><span class="headtitle">Upload Yo</span><span>ur Recipe</span></div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea style="resize:none;width:1123px;height:250px;" id="instructions" class="form-control" name="instructions" placeholder="Instructions (descriptive)"></textarea>
            </div>
